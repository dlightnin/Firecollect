...
<!-- <div class='row'> -->
                                              ...
                                              echo "<div class='col-lg-3 col-md-4 col-sm-6 col-xs-12'>
                                                      ...
                                                      <div data-toggle='modal' href='#modal_img$i' >
                                                          <img id='img$i' class='imgcheck' style='height:188px;width:281px;' name = $file_name src='uploads/image_uploads/$project_id/$file_name' />
                                                      </div>
                                                      </div>
                                                                                            ...
                                                                                            <div class='portlet-body form'>
                                                                                              <form role='form' method='POST' action='includes/upload_image.php' enctype='multipart/form-data'>
                                                                                                ...
                                                                                                <div class='row'>
                                                                                                    ...
                                                                                                    <div class='col-md-7'>
                                                                                                        <img src='uploads/image_uploads/$project_id/$file_name'  style='height:100%;width:100%'/>
