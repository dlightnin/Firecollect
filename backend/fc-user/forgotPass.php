...
<body class="login">
    ...
    <div class="content">
      ...
      <form action="includes/passChange.php" method="post" style="display:block !important;" class="register-form">
          <h3 class="font-green">Forgot password?</h3>
          <p class="hint"> Enter your e-mail address below to reset your password. </p>
