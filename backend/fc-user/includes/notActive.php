<?php
  ...
  $res = $db_conn->query("SELECT activation_hash from tbl_user where email = '$email'") ;
  $res = $res->fetch_assoc() ;
  $token = $res['activation_hash'] ;
 ...
 <html lang="en">
     ...
     <body class=" login">
        ...
        <div class="content" align='center'>
             ...
             <p>
               Please activate your account. You can resend the activation link by clicking
               <?php
               echo "<form action='register.php' method='post'>
                        <input value=".$email." name='email' style='display:none'/>
                        <input value=".$token." name='token' style='display:none'/>
                        <button type='submit' class='btn green uppercase'>Here</button>
                     </form>" ; // LEFT HERE
               ?>
             </p>
