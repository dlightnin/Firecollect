...
$mail->addReplyTo('oficina.catec@upr.edu', '');

//Set who the message is to be sent to
$mail->addAddress($email,'');

//Set the subject line
$mail->Subject = 'Firecollect password change';
...
$mail->Body = "<html>
                ...
                <div style='width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 11px;'>
                  <h1>Click on the button below to reset your Firecollect password.</h1>
                  <div align='center'>
                  <button class='btn green uppercase'>
                    <a style='text-decoration:none ; color:black' href='136.145.54.38/~catec/firecollect_ts/backend/fc-user/includes/resetPass.php?token=".$token."'>Change password</a>
                  </button>
                  </div>
...
else
{
    ...
    $accountQuery = "UPDATE tbl_user set forgot_hash = '$token' where email = '$email'" ;
