                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                                    ...
                                    <li>
                                        <ul class="dropdown-menu-list scroller " style="height: 275px;" data-handle-color="#637283" >
                                            ...
                                            while($row = $req->fetch_assoc())
                                            {
                                              ...
                                              echo "<li style='position:relative;'>
                                                  ...
                                                  <a style='border-bottom:none !important;'>
                                                      <span class='photo'>
                                                          <img src='../fc-user/img/".$s['image_path']."' class='img-circle' alt=''> </span>
                                                      <span class='subject'>
                                                      ...
                                                      <a href='../fc-user/includes/acceptInvitation.php?p_id=".$project."&r_id=".$row['request_id']."' style='width:100%;text-decoration:none;color:white;position:absolute;'  class='btn invite_btn btn-info btn-accept' >accept</a>
                                                      </div>
                                                      <div class='col-md-6 col-sm-6 col-xs-6''>

                                                      <a href='../fc-user/includes/declineInvitation.php?r_id=".$row['request_id']."' style='width:100%;text-decoration:none;color:white;position:absolute;right:0;' class='btn invite_btn btn-danger btn-decline'>decline</a>
                                                    </div>
                                                  </div>
                                          ...
                                          $(document).on("click", '.invite_btn', function(event) {
                                            $(".invite_dropdown ").load("load_ajax/topMenu.php .invite_dropdown",
                                                function () {
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src='<?="../fc-user/img/".$info['image_path']?>' />
